...
FROM owners o JOIN users u ON o.user_id = u.id WHERE u.email = 'pension@test.com';
...
FROM owners o JOIN users u ON o.user_id = u.id WHERE u.email = 'class@test.com';
...
FROM owners o JOIN users u ON o.user_id = u.id WHERE u.email = 'facility@test.com';
